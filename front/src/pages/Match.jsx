...
function Match() {
  ...
  const fortunes = [
    ...
    { content: "만약 당신이 스트레스를 받고 있다면 오늘 하루는 아무생각 없이 놀아보세요.", },
    { content: "過猶不及 (과유불급) 이란 말이 있습니다. 무엇이든 적당히..." },
    { content: "轉禍爲福 (전화위복) 이란 말이 있습니다. 노력한다면 불행을 행복으로 바꿀 수 있습니다. 위기라면 끝 없이 노력하세요.", },
    ...
    { content: "벼는 익을수록 고개를 숙인다 라는 말이 있습니다. 기고만장 해지지 마세요.", },
  ];
